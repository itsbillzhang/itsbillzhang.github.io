...
<p class="centered-text">
<img class="centered" src="{{site.url}}/images/Intention.png" />
</p>
...
All in all, this was one of the most fun projects I had ever done, and I will try my hand at bigger bots in the future, with the next one either generative or retrieval-based. After spending tens of hours on Hamilton, closing the program felt strangely saddening. For the time being, Hamilton lives [here](https://github.com/itsbillzhang/Chatbots/blob/master/BubbleTea%20Chatbot), feel free to experiment with it!

<p class="centered-text">
<img class="centered" src="{{site.url}}/images/Ending_text.PNG" />
</p>
